...
/* added for file partioning @bug 808 */
EXTERN int file_partition;
...
#define  TOTDATE      2557
#define  STARTPARTITION 1992  /* @bug 808 partition */
#define  PARTITIONS   85      /* @bug 808 partition */
#define  UPD_PCT      10
...
EXTERN FILE* line_partitions[PARTITIONS];  
EXTERN FILE* order_partitions[PARTITIONS]; 
