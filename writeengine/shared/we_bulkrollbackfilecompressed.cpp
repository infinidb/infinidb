...
/*
* $Id: we_bulkrollbackfilecompressed.cpp 3603 2012-03-06 16:39:32Z dcathey $
*/
...
//------------------------------------------------------------------------------
int BulkRollbackFileCompressed::truncateSegmentFile(
	OID       columnOID,
	u_int32_t dbRoot,
	u_int32_t partNum,
	u_int32_t segNum,
...
//------------------------------------------------------------------------------
int BulkRollbackFileCompressed::reInitTruncColumnExtent(
	OID         columnOID,
	u_int32_t   dbRoot,
	u_int32_t   partNum,
	u_int32_t   segNum,
...
// nBlocks        - Number of blocks to be reinitialized
//------------------------------------------------------------------------------
int BulkRollbackFileCompressed::reInitTruncDctnryExtent(
	OID         dStoreOID,
	u_int32_t   dbRoot,
	u_int32_t   partNum,
	u_int32_t   segNum,
