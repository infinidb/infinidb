...
const uint64_t BIN16NULLLOW      = 0xFFFFFFFFFFFFFFFEULL;
const uint64_t BIN16NULLHIGH     = 0xFFFFFFFFFFFFFFFFULL;
const uint64_t BIN16EMPTYROWLOW  = 0xFFFFFFFFFFFFFFFFULL;
const uint64_t BIN16EMPTYROWHIGH = 0xFFFFFFFFFFFFFFFFULL;
