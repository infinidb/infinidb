...
//  $Id: groupconcat.h 8436 2012-04-04 18:18:21Z rdempsey $
...
public:
	...
	virtual void getResult(uint8_t* buff, std::string sep) = 0;
...
public:
	...
	void getResult(uint8_t* buff, std::string sep);
...
class GroupConcatOrderBy : public GroupConcator, public IdbOrderBy
{
public:
	GroupConcatOrderBy();
