...
public:
	...
	*/
	...
	inline static std::string& schemaName()	{	return fSchemaName;	}
	inline static void schemaName(const std::string& schemaName) { fSchemaName = schemaName; }
	
	inline static std::string& tableName() { return fTableName;	}
	inline static void tableName(const std::string& tableName) { fTableName = tableName; }
