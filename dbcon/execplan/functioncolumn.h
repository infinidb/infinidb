...
/***********************************************************************
*   $Id: functioncolumn.h 7705 2011-05-17 17:18:13Z xlou $
*
*
***********************************************************************/
/** @file */
...
public:
	FunctionColumn();
	FunctionColumn(const std::string& functionName, const std::string& funcParmsInString, const u_int32_t sessionID = 0);
	FunctionColumn( const FunctionColumn& rhs, const u_int32_t sessionID = 0);
	 ...
	 */
	void funcParms(const funcexp::FunctionParm& functionParms)
	{
	 ...
	 */
	void functionParms(const std::string& funcParmsInString);
...
public:
	...
	{ 
		return fFunctor->getStrVal(row, fFunctionParms, isNull, fOperationType);
	}
