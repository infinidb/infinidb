...
public:
	...
	*/
	 ...
	 */
	EXPORT bool getUncompressedSize(char *in, size_t inLen, size_t *outLen) const;
...
inline bool IDBCompressInterface::getUncompressedSize(char* in, size_t inLen, size_t* outLen) const { return false; }
#endif
