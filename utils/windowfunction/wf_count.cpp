...
template<typename T>
shared_ptr<WindowFunctionType> WF_count<T>::makeFunction(int id, const string& name, int ct)
{
...
template
shared_ptr<WindowFunctionType> WF_count<int64_t>::makeFunction(int, const string&, int);
