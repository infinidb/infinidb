...
public:
   ...
   /** @brief build the batch distribution sequence in a vector
    ...
    /** @brief get the batch distribution sequence in a vector
      * return the vector of PMId sequence, batches of data be distributed
      */
    std::vector<uint> getBatchDistributionVector();
    /**
