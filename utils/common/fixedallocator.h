...
public:
	...
	EXPORT void * allocate(uint len);  // a hack to make it work more like a pool allocator (use PoolAllocator instead)
	EXPORT void truncateBy(uint amt);   // returns a portion of mem just allocated; use with caution
