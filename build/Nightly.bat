...
@echo off
bash \InfiniDB\src\tools\reserveStacks\stack reserve srvbldwin1 nightly f:/Calpont
::call Switch.bat
...
call \InfiniDB\src\build\CopyToCalweb.bat

echo running the nightly test scripts
cd \InfiniDB\src\mysql\queries\nightly\srvswdev11
...
cd \
expect /InfiniDB/src/build/CopyLog.sh
xcopy build.log f:\nightly\build_log\%archivedirname%\
bash \InfiniDB\src\tools\reserveStacks\stack release srvbldwin1 nightly f:/Calpont
exit 1
