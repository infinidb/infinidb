...
### InfiniDB MySQL
    ...
    wget -Omysql-4.5.2-1.tar.gz https://github.com/infinidb/mysql/archive/4.5.2-1.tar.gz
    tar -zxf mysql-4.5.2-1.tar.gz
    ln -s mysql-4.5.2-1 mysql
    cd mysql
...
### InfiniDB
    ...
    cd ..
    wget -Oinfinidb-4.5.2-1.tar.gz https://github.com/infinidb/infinidb/archive/4.5.2-1.tar.gz
    tar -zxf infinidb-4.5.2-1.tar.gz
    ln -s infinidb-4.5.2-1 infinidb
    cd infinidb
