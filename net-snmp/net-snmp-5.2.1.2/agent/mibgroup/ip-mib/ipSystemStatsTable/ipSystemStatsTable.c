 ...
 *
 * $Id: ipSystemStatsTable.c,v 1.3 2004/10/16 00:31:18 rstory Exp $
 */
                                ...
                                user_context)
{
    ...
    /*
     * TODO:511:o: Perform ipSystemStatsTable pos-request actions.
     */
                            ...
                            u_long * ipSystemStatsInReceives_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsInReceives_val_ptr ) from rowreq_ctx->data
     */
                          ...
                          u_long * ipSystemStatsInOctets_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsInOctets_val_ptr ) from rowreq_ctx->data
     */
                             ...
                             u_long * ipSystemStatsInHdrErrors_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsInHdrErrors_val_ptr ) from rowreq_ctx->data
     */
                            ...
                            u_long * ipSystemStatsInNoRoutes_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsInNoRoutes_val_ptr ) from rowreq_ctx->data
     */
                              ...
                              u_long * ipSystemStatsInAddrErrors_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsInAddrErrors_val_ptr ) from rowreq_ctx->data
     */
                                 ...
                                 ipSystemStatsInUnknownProtos_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsInUnknownProtos_val_ptr ) from rowreq_ctx->data
     */
    (*ipSystemStatsInUnknownProtos_val_ptr) =
                                 ...
                                 ipSystemStatsInTruncatedPkts_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsInTruncatedPkts_val_ptr ) from rowreq_ctx->data
     */
    (*ipSystemStatsInTruncatedPkts_val_ptr) =
                                 ...
                                 ipSystemStatsInForwDatagrams_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsInForwDatagrams_val_ptr ) from rowreq_ctx->data
     */
    (*ipSystemStatsInForwDatagrams_val_ptr) =
                            ...
                            u_long * ipSystemStatsReasmReqds_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsReasmReqds_val_ptr ) from rowreq_ctx->data
     */
                          ...
                          u_long * ipSystemStatsReasmOKs_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsReasmOKs_val_ptr ) from rowreq_ctx->data
     */
                            ...
                            u_long * ipSystemStatsReasmFails_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsReasmFails_val_ptr ) from rowreq_ctx->data
     */
                            ...
                            u_long * ipSystemStatsInDiscards_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsInDiscards_val_ptr ) from rowreq_ctx->data
     */
                            ...
                            u_long * ipSystemStatsInDelivers_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsInDelivers_val_ptr ) from rowreq_ctx->data
     */
                             ...
                             u_long * ipSystemStatsOutRequests_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsOutRequests_val_ptr ) from rowreq_ctx->data
     */
                             ...
                             u_long * ipSystemStatsOutNoRoutes_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsOutNoRoutes_val_ptr ) from rowreq_ctx->data
     */
                                  ...
                                  ipSystemStatsOutForwDatagrams_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsOutForwDatagrams_val_ptr ) from rowreq_ctx->data
     */
    (*ipSystemStatsOutForwDatagrams_val_ptr) =
                             ...
                             u_long * ipSystemStatsOutDiscards_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsOutDiscards_val_ptr ) from rowreq_ctx->data
     */
                              ...
                              u_long * ipSystemStatsOutFragReqds_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsOutFragReqds_val_ptr ) from rowreq_ctx->data
     */
                            ...
                            u_long * ipSystemStatsOutFragOKs_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsOutFragOKs_val_ptr ) from rowreq_ctx->data
     */
    (*ipSystemStatsOutFragOKs_val_ptr) =
        rowreq_ctx->data->stats.OutFragOKs;
                              ...
                              u_long * ipSystemStatsOutFragFails_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsOutFragFails_val_ptr ) from rowreq_ctx->data
     */
                                ...
                                ipSystemStatsOutFragCreates_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsOutFragCreates_val_ptr ) from rowreq_ctx->data
     */
    (*ipSystemStatsOutFragCreates_val_ptr) =
                              ...
                              u_long * ipSystemStatsOutTransmits_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsOutTransmits_val_ptr ) from rowreq_ctx->data
     */
                           ...
                           u_long * ipSystemStatsOutOctets_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsOutOctets_val_ptr ) from rowreq_ctx->data
     */
                             ...
                             u_long * ipSystemStatsInMcastPkts_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsInMcastPkts_val_ptr ) from rowreq_ctx->data
     */
                               ...
                               u_long * ipSystemStatsInMcastOctets_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsInMcastOctets_val_ptr ) from rowreq_ctx->data
     */
                              ...
                              u_long * ipSystemStatsOutMcastPkts_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsOutMcastPkts_val_ptr ) from rowreq_ctx->data
     */
                                ...
                                ipSystemStatsOutMcastOctets_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsOutMcastOctets_val_ptr ) from rowreq_ctx->data
     */
    (*ipSystemStatsOutMcastOctets_val_ptr) =
                             ...
                             u_long * ipSystemStatsInBcastPkts_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsInBcastPkts_val_ptr ) from rowreq_ctx->data
     */
                              ...
                              u_long * ipSystemStatsOutBcastPkts_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsOutBcastPkts_val_ptr ) from rowreq_ctx->data
     */
                                   ...
                                   ipSystemStatsDiscontinuityTime_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsDiscontinuityTime_val_ptr ) from rowreq_ctx->data
     */
    (*ipSystemStatsDiscontinuityTime_val_ptr) =
                             ...
                             u_long * ipSystemStatsRefreshRate_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     * set (* ipSystemStatsRefreshRate_val_ptr ) from rowreq_ctx->data
     */
